...

  {
    ...
    body: (a) => [
      ...
      U.section({
        ...
        inner: U.cards([
          { d: 'Sorts every upload into its report type — CBC, LFT, KFT, Lipid Profile, Prescription, Discharge Summary, Radiology, Pathology, ECG — or Unknown.', icon: '◇' },
          { d: 'Reads scanned and photographed documents, with consensus ensemble support.', icon: '◎' },
          { d: 'Pulls out the clinical entities — TEST, VALUE, UNIT, REFERENCE_RANGE, MEDICATION, DOSAGE, DIAGNOSIS, SYMPTOM, BODY_PART, DATE, DOCTOR, HOSPITAL.', icon: '⬡' },
          { d: 'Maps Hb / Hemoglobin / HGB to one concept — LOINC, UCUM, ICD, RxNorm.', icon: '∞' },
          { d: 'Cautious, understandable explanations for patients. No diagnosis language.', icon: '▤' },
          { d: 'For doctors — findings, abnormalities, historical changes, follow-up items, missing information.', icon: '▤' },
          { d: 'Recommends workflow urgency only. Never a disease claim.', icon: '◉' },
          { d: 'Catches unsupported conclusions, contradictions, hallucinations, dangerous advice, missing context and uncertainty.', icon: '▣' },
        ], { cols: 2 }),
      }),
      U.section({
